#ifndef _SZ_ADAPTIVE_REGRESSION_PREDICTOR_HPP
#define _SZ_ADAPTIVE_REGRESSION_PREDICTOR_HPP
...
// N-d regression predictor
    ...
    class AdaptiveRegressionPredictor : public concepts::PredictorInterface<T, N> {
    public:
        ...
        void save(uchar *&c) const {
            ...
            *reinterpret_cast<size_t *>(c) = regression_coeff_quant_inds.size();
            ...
            if (!regression_coeff_quant_inds.empty()) {
                quantizer_independent.save(c, 0);
                quantizer_liner.save(c, 1);
    ...
    private:
        ...
        AdaptiveLinearQuantizer<T> quantizer_liner, quantizer_independent;
