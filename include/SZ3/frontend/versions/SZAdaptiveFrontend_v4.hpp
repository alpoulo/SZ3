#ifndef SZ3_ADAPTIVEFRONTEND
#define SZ3_ADAPTIVEFRONTEND
/**
 * This module is the implementation of adaptive frontend in SZ3
 */
...
namespace SZ {
    ...
    class SZAdaptiveFrontend : public concepts::FrontendInterface<T, N> {
    public:

        SZAdaptiveFrontend(const Config &conf, Predictor predictor, Quantizer quantizer) :
        ...
        std::vector<int> compress(T *data) {
            ...
            //add logic: is quantizer adaptive? if yes, call below
...
//            quantizer.print();
        ...
        size_t get_num_elements() const { return num_elements + quantizer.get_num_adaptive(); }
    ...
    template<class T, uint N, class Predictor, class Quantizer>
    SZAdaptiveFrontend<T, N, Predictor, Quantizer>
    make_sz_adaptive_frontend(const Config &conf, Predictor predictor, Quantizer quantizer) {
        return SZAdaptiveFrontend<T, N, Predictor, Quantizer>(conf, predictor, quantizer);
    }
}
